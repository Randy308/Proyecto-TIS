                    ...
                    @else
                        <div class="form-outline mb-4">
                            ...
                            <div class="slider">
                                ...
                                <input name="nota_maxima" type="range" id="formMaximo" min="10" step="5"
                                    max="200" value="100"
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <div class="slider">
                                ...
                                <input type="range" name="nota_minima_aprobacion" id="formMinimo" min="0"
                                    max="200" value="51"
                        ...
                        <div>
                            <p class="fs-6 fw-normal">Si crea una calificacion , se deshabilitara la opcion para aceptar
                                la solicitud de mas grupos al evento</p>
                        </div>
                    @endif
