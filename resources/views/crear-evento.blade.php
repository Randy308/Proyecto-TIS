                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/crear-evento" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 borde-celeste">
                                <div>
                                    <label for="Titulo" class="form-label"
                                        style="font-family: 'Inter', sans-serif; font-weight: 600; color: #61758A;">
                                        Título:
                                    </label>
                                </div>
                            ...
                            <div class="mb-3 borde-celeste">
                                <div>
                                    <label for="DireccionImg" class="form-label"
                                        style="font-family: 'Inter', sans-serif; font-weight: 600; color: #61758A;">
                                        Banner (JPEG/PNG/GIF):
                                    </label>
                                </div>
                                <input type="file" name="DireccionImg" class="form-control-file"
                            ...
                            <div class="mb-3 borde-celeste">
                                ...
                                <select name="Estado" class="form-select" style="font-family: 'Inter', sans-serif;"
                                    required>
