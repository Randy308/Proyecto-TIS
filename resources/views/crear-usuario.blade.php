                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="card rounded-3">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Creación de Usuario</h3>
                            ...
                            <form action='{{ route('registroParticipante.store') }}' method="POST" class="px-md-2"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input class="form-control-file" name="foto_perfil" type="file" id="formFile"  ngf-pattern="'image/*'" accept="image/*" ngf-max-size="2MB" hidden >
                                        ...
                                        <div class="form-group">
                                            <img id="imagen-preview" src="/storage/image/default_user_image.png" alt="Imagen predeterminada" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
