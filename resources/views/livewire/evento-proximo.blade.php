    ...
    @if (!empty($evento))
        <div class="content p-5 mt-4">
            <div class="card ">
                ...
                <div class="card-body">
                    <p class="h6">{{ $evento->descripcion_evento }}</p>
                    <p class="h6">{{ $evento->direccion_banner }}</p>
                    <p class="h6">{{ $evento->fecha_inicio }}</p>
            ...
            <input type="datetime-local" id="meeting-time" name="meeting-time" value="{{ $evento->fecha_inicio }}T19:30"
                min="2023-06-07T00:00" max="2024-06-14T00:00" />
        </div>
    @endif
