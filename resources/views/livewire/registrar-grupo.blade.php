<div>
    ...
    <div class="d-flex px-2">
        ...
        <input class="w-100" style="" type="text" wire:model="nombreEquipo" id="grupoInput"
    ...
    <div class="px-2">
        <div class="d-flex mb-3">
            ...
            <input style="width:36%;" type="text" wire:model.defer="email1" placeholder="Correo Electronico" required>
